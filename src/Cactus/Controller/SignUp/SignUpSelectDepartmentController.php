...
class SignUpSelectDepartmentController implements ITemplateController
{
    ...
    public function get_departments(RenderContext $context): string
    {
        ...
        foreach ($departments as $department) {
            ...
            $url = "http://127.0.0.1:8080/public/index.php?lang=fr&path=sign-up/$regionCode/$departmentCode/grade";
